                ...
                var FileMenu = function () {
                    ...
                    FileMenu.prototype._addImportListeners = function () {
                        $("#import-json").on('click', function (e) {
                            ...
                            var button = $(e.currentTarget),
                                ...
                                actionArgs = button.data('actionArgs');
                        ...
                        $("#import-excel").on('click', function (e) {
                            ...
                            var dataOnly = $('#import_excel_dataOnly').prop('checked') ? 1 : 0,
                                ...
                                rowAndColumnHeaders = $('#import_excel_rowAndColumnHeaders').prop('checked') ? 12 : 0,
                        ...
                        $("#import-csv").on('click', function (e) {
                            var button = $(e.currentTarget),
                                action = button.data('action');
                            var includeRowHeaders = $('#import_csv_includeRowHeader').prop('checked') ? 1 : 0,
                                dataAndFormulasOnly = $('#import_csv_includeColumnHeader').prop('checked') ? 2 : 0,
                                unformatted = $('#import_csv_unformatted').prop('checked') ? 8 : 0,
                                importFormula = $('#import_csv_importFormula').prop('checked') ? 16 : 0;
                    ...
                    FileMenu.prototype._addExportListeners = function () {
                        ...
                        $("#export-excel").on('click', function (e) {
                            var button = $(e.currentTarget),
                                action = button.data('action');
                            var dataOnly = $('#export_excel_dataOnly').prop('checked') ? 32 : 0,
                                noFormulas = $('#export_excel_noFormulas').prop('checked') ? 1 : 0,
                                autoRowHeight = $('#export_excel_autoRowHeight').prop('checked') ? 4096 : 0,
                                saveAsFiltered = $('#export_excel_saveAsFiltered').prop('checked') ? 8 : 0,
                                saveAsViewed = $('#export_excel_saveAsViewed').prop('checked') ? 136 : 0,
                                saveBothCustomRowAndColumnHeaders = $('#export_excel_saveBothCustomRowAndColumnHeaders').prop('checked') ? 6 : 0,
                                saveCustomRowHeaders = $('#export_excel_saveCustomRowHeaders').prop('checked') ? 2 : 0,
                                saveCustomColumnHeaders = $('#export_excel_saveCustomColumnHeaders').prop('checked') ? 4 : 0;
                        ...
                        $("#export-csv").on('click', function (e) {
                            var button = $(e.currentTarget),
                                action = button.data('action');
                            var includeRowHeader = $('#export_csv_includeRowHeader').prop('checked') ? 1 : 0,
                                includeColumnHeader = $('#export_csv_includeColumnHeader').prop('checked') ? 2 : 0,
                                unFormatted = $('#export_csv_unFormatted').prop('checked') ? 8 : 0,
                                exportFormula = $('#export_csv_exportFormula').prop('checked') ? 16 : 0,
                                asViewed = $('#export_csv_asViewed').prop('checked') ? 32 : 0;
