...
swfobject.addDomLoadEvent(function () {
            ...
            case 5:
                ...
                if (json.type == 0) {
                    ...
                    if (json.content.sourceUrl) {
                        button.push({ text: '修改头像', callback: function callback() {
                                this.close();
    ...
    var swf1 = new fullAvatarEditor('swf1', 335, (_ref = {
        id: 'swf1',
        ...
        avatar_sizes_desc: '258*200像素' }, _defineProperty(_ref, 'browse_box_align', 'left'), _defineProperty(_ref, 'webcam_box_align', 'left'), _defineProperty(_ref, 'avatar_intro', '     最终会生成下面这个尺寸的头像'), _defineProperty(_ref, 'avatar_tools_visible', true), _ref), callback);
    //选项卡点击事件
